...
country = {
	...
	AI_SUPPORT_REFORM = 0, -- At least this many % needs to support a reform for the AI to take it
...
military = {
	...
	AI_SPECIAL_PROPORTION = 0.3, -- fraction of brigades that should be engineers and tanks
	AI_ESCORT_RATIO = 2.0, -- ratio of escorts to transports in invasion fleets
	AI_ARMY_TAXBASE_FRACTION = 1, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
	AI_NAVY_TAXBASE_FRACTION = 1, -- max of tax base that AI will spend on navy supply costs (based on peacetime costs)
	AI_BLOCKADE_RANGE = 2500, -- max distance the AI will send out blockade fleets from their home base
...
ai =
{
	...
	SOLDIER_FRACTION = 0.2, -- max amount of population AI wants to be soldiers
