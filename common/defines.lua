...
military = {
    ...
    AI_BIGSHIP_PROPORTION = 0.60, -- fraction of ships in the navy that should be ships of the line
    AI_LIGHTSHIP_PROPORTION = 0.40, -- fraction of ships in the navy that should be cruisers, frigates etc
    AI_TRANSPORT_PROPORTION = 0.15, -- fraction of ships in the navy that should be should be transports
    AI_CAVALRY_PROPORTION = 0.50, -- fraction of brigades that should be cavalry
    AI_SUPPORT_PROPORTION = 1.0, -- fraction of brigades that should be artillery and other support units
    AI_SPECIAL_PROPORTION = 0.80, -- fraction of brigades that should be engineers and tanks
    AI_ESCORT_RATIO = 5.0, -- ratio of escorts to transports in invasion fleets
    AI_ARMY_TAXBASE_FRACTION = 5.0, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
    AI_NAVY_TAXBASE_FRACTION = 6.0, -- max of tax base that AI will spend on navy supply costs (based on peacetime costs)
    AI_BLOCKADE_RANGE = 12000, -- max distance the AI will send out blockade fleets from their home base
...
diplomacy = {
    ...
    NEIGHBOUR_BONUS_INFLUENCE_PERCENT = 0.75, -- Bonus to neighbouring countries when influencing
...
ai =
{
    ...
    CLERGYMEN_FRACTION = 0.03, -- max amount of population AI wants to be clergymen
    CLERKS_FRACTION = 0.03, -- max amount of population AI wants to be clerks
    ...
    NAVAL_SUPPLY_PENALTY_LIMIT = 0.35, -- AI will allow to have max X% of supply penalty (when too little naval bases)
    CHANCE_BUILD_RAILROAD = 1.0, -- chances in % of AI decisions (max value 1.0)
    CHANCE_BUILD_NAVAL_BASE = 1.0,
    CHANCE_BUILD_FORT = 1.0,
    ...
    PEACE_WAR_EXHAUSTION_FACTOR = 0.2, -- AI willingness to peace based on war exhaustion
    ...
    AGGRESSION_BASE = 10000, -- general AI aggression
    ...
    MONTHS_BEFORE_DISBAND = 30000, -- Months from start date before AI will disband armies/navies (to avoid disbands because of early economic turmoil)
},
